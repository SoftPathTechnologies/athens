(function ($) {
    ...
    $('.loadmore-one-item').on('click', function (e) {
        ...
        if (_set.length) {
            ...
            _this.text('No more schedule to display');
        }
        return false;
    });
    /*********************************/
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-nav-back'><a href='#'><img src='assets/img/logo.png'/></a></div>"
    });
    ...
    $(window).on('load', function () {
        ...
        if (eventCounter.length) {
            eventCounter.countdown('2022/05/16', function(e) {
