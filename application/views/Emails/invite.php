...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="margin:0; padding:0; background-color:#FFF">
    ...
    />
    <div style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Athens 2022 Health Conference Invitation </div>
                                                ...
                                                width="100%">
                                                  <tbody>
                                                    <tr>
                                                      ...
                                                      valign="top">
                                                        <p style="margin-bottom:0; margin-left:0; margin-right:0; margin-top:0; padding-bottom:1em"><span style="font-size:26px;"><strong><span style="color:#24ad69;">Hi there,</span>
                                                          </strong>
                                                          </span>
                                                        </p>
                                                        ...
                                                        <p style="margin-bottom:0; margin-left:0; margin-right:0; margin-top:0; padding-bottom:1em"><span style="font-size:16px;">Glad to have you on board.  Hope this meets you well.</span>
                                                        </p>
                                                        <p style="margin-bottom:0; margin-left:0; margin-right:0; margin-top:0; padding-bottom:1em"><span style="font-size: 16px;">You have been invited to participate in <b>Athens 2022 Health Conference.</b> To know more about the event and book your registration, click the link below</span>
                                                        </p>
                                                      <h3 style="text-align: center; color:#24AD69" ><a href="<?php echo base_url() ?>" target="_blank">AGEFADD 2022 Health Conference, Athens.</a></h3>
